...
public class RecommendationService {
    ...
    public void analyzeAlternativeFood(Meal meal) throws IOException {
        String solution = String.format(
                "%s는 가속노화를 촉진시키는음식이야. %s에 들어가는 음식 재료들을 분석해보고 주재료 중에서 가속노화를 촉진시키는걸 찾아서 같은 카테고리의 다른 저속노화에 좋은 재료로 대체해주고 그 이유를 적어줘. 대체 재료는 노화에 좋은 재료로 선택해줘. 예시를 보여주자면 마라탕일 경우 밀가루 면을 두부 면으로 대체하면 저속노화에 좋겠지? 그리고 실제로 해당 재료를 대체할 수 있을만한 걸로 해줘. 식감이나 그 재료가 하는 역할이 비슷하도록. 다른 말은 하지 말고, 다음과 같은 형식으로 대답해줘: {\"대체재료\": \"대체할 재료 이름\", \"대체대상재료\": \"대체될 재료 이름\", \"이유\": \"대체대상재료로 대체해야하는 이유\"}",
